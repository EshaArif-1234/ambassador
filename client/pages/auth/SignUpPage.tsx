          ...
          <div className="flex flex-col lg:flex-row">
            ...
            <div className="lg:w-1/2 bg-orange-500 p-6 lg:p-8 flex flex-col justify-center items-center text-white">
              <div className="text-center">
                ...
                <h2 className="text-2xl font-bold mb-4">Welcome to Ambassadors</h2>
                <p className="text-orange-100 mb-6">
                  Join thousands of satisfied customers who trust us for their kitchen and restaurant equipment needs.
                </p>
                ...
                <div className="space-y-4 text-left max-w-sm mx-auto">
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <h3 className="font-semibold">Premium Quality Equipment</h3>
                      <p className="text-orange-200 text-sm">Commercial-grade kitchen solutions</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-orange-200 text-sm">Dedicated customer service team</p>
                    </div>
                  </div>
