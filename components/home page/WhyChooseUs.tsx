...
const reasons = [
  ...
  },
  {
    ...
    description:
      'Fully tailored kitchen layouts designed and fabricated to your exact space, capacity and menu requirements.',
  },
  {
    icon: (
      <svg className="h-5 w-5 sm:h-6 sm:w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden>
    ...
    description:
      'Dedicated in-house service team for maintenance, repairs, and spare parts — keeping your kitchen running.',
  },
  {
    icon: (
      <svg className="h-5 w-5 sm:h-6 sm:w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden>
    ...
    <div className="container mx-auto px-4">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-5 md:gap-6 lg:grid-cols-3">
        {reasons.map((reason, i) => (
          ...
          >
            <div className="mb-3 flex h-10 w-10 items-center justify-center rounded-lg bg-[#E36630]/10 text-[#E36630] transition-colors duration-300 group-hover:bg-[#E36630] group-hover:text-white sm:mb-4 sm:h-12 sm:w-12 sm:rounded-xl">
              {reason.icon}
            </div>
